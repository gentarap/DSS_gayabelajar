...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <form method="GET" action="{{ route('admin.questions.index') }}" class="flex space-x-4 mb-4">
        <div>
            <label for="sort" class="block text-sm font-medium text-gray-700">Filter</label>
            <select name="sort" id="sort" class="mt-1 block rounded-md border-gray-300 shadow-sm">
                <option value="question_id" {{ $sort === 'question_id' ? 'selected' : '' }}>ID</option>
                <option value="question_text" {{ $sort === 'question_text' ? 'selected' : '' }}>Abjad</option>
                <option value="created_at" {{ $sort === 'created_at' ? 'selected' : '' }}>Terakhir Dibuat</option>
                <option value="updated_at" {{ $sort === 'updated_at' ? 'selected' : '' }}>Terakhir Diubah</option>
            </select>
        </div>

        <div>
            <label for="direction" class="block text-sm font-medium text-gray-700">Urutan</label>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white border border-gray-200 rounded-lg">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                {{-- TIDAK ADA sort atau sortBy DI SINI --}}
                                                    ...
                                                    <td class="py-4 px-4 whitespace-nowrap text-sm font-medium">
                                                        <div class="flex flex-col space-y-1 sm:flex-row sm:space-y-0 sm:space-x-2">
                                                            <a href="{{ route('admin.questions.edit', $question->question_id) }}"
                                                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 hover:text-blue-700"
                                                                title="Edit Question">
                                                            ...
                                                            <a href="{{ route('admin.questions.answers.create', $question->question_id) }}"
                                                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-green-600 bg-green-50 border border-green-200 rounded-md hover:bg-green-100 hover:text-green-700"
                                                                title="Add Answer">
                                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            ...
                                                            <form action="{{ route('admin.questions.delete', $question->question_id) }}"
                                                                ...
                                                                @method('DELETE')
                                                                <button type="submit"
                                                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-red-600 bg-red-50 border border-red-200 rounded-md hover:bg-red-100 hover:text-red-700"
